 ...
 */
  ...
  */
  ...
  class GoogleRequest {
     ...
     * @param string $google_order the google id of the order
     * 
     * @returray the status code and body of the response
     */
    ...
    nction SendShipItems($google_order, $items_list=array(), $send_mail="true") {
      $postargs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
     ...
     * 
     * info: {@link http://code.google.com/apis/checkout/developer/Google_Checkout_XML_API_Line_Item_Shipping.ing.html#tag_cancel-items}
     * 
     * @param string $google_order the google id of the order
     * @param array $items_list a list of GoogleShipItem classes.
     * @param string $reason the reason why the refund is taking place
    ...
    function SendResetItemsShippingInformation($google_order, $items_list=array(), $send_mail="true") {
      $postargs = "<?xml version=\"1.0\" encoding=\args = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
