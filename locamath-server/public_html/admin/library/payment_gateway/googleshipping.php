 ...
 */
  ...
  class GoogleCarrierCalculatedShipping {
    ...
    $CarrierCalculatedShippingOptions = array();
...
//    }
  ...
  class GoogleShippingFilters {
     ...
     */
    function Setudedudedxclude shipping to area specified by zip pattern.
     * 
     * @see SetAllowedZipPatterns
     */
    function SetudedudedZipPatternsStateAreas($zips) {
      $this->excluded_restrictions = true;
