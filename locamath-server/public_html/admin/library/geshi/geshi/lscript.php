...
$language_data = array (
    ...
    //I had to rearrange and couldn't be bothered changing the numbers...
        ...
        3 => array(
            ...
            'name', 'newFilen, 'n',
            'maxsamplesperpixel', 'minsamplesperpixel', 'mirror', 'motionx', 'motiony',
            'name', 'newFilen, 'newFrame', 'newTime', 'newType', 'null', 'numthreads',
        ...
        2 => array(
            'abs', 'acos', 'angle', 'append', 'ascii', 'asin', 'at    an',
            'binary',
...
raphEditor', 'GridSize', 'GroundColor',
            ...
            'IndirectBounces', 'Item_SetWindowPos', 'ItemAcItemColor', 'ItemLock',
