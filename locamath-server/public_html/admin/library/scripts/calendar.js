...
Calendar.cellClick = function(el, ev) {
	...
	if (typeof el.navtype == "undefined") {
		...
		// Odin: to keep selected time
		var hhh = cal.date.getHours();
		var mmm = cal.date.getMinutes();
		//----------------------------
		
		cal.date = new Date(el.caldate);
		
		// Odin: to keep selected time
		cal.date.setHours(hhh);
		cal.date.setMinutes(mmm);
		//----------------------------
