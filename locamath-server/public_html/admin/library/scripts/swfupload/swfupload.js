...
SWFUpload.prototype.initSettings = function () {
  ...
  this.inputName = this.settings.input_name;
...
SWFUpload.prototype.fileQueueError = function (file, errorCode, message, mess_for_user) {
  file = this.unescapeFilePostParams(file);
  this.queueEvent("file_queue_error_handler", [file, errorCode, message, this.settings.max_file_size_exceeded_mess]);
};
