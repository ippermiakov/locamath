...
jQuery.fn.kiketable_colsizable = function(o) {
	...
	this
		...
		.each(function(index){
			...
			$(o.dragCells,this)
				.each(function(index){
					if ($(this).find("> div.kiketable-th-text").length == 0)
					...
					$('<div class="'+o.classHandler+'" title="'+ o.title+'"></div>')
						...
						.dblclick( function() { 
							...
							this.td.style.width = this.wtd + "px";
						...
						.bind( 'drag', (o.dragMove || o.dragProxy)? function(e){ 
								...
								if(w - this.d2 - this.d1 >= 0){
									...
									if (o.dragMove){
										this.td.style.width = w +"px"; // cell width
										if(!o.fixWidth){
						...
						.bind( 'dragend', function(e){ 
							if (!o.dragMove){
								...
								this.td.style.width = (o.dragProxy) ? e.dragProxy.style.width : (this.cell_width + delta)+"px"; // cell width
								// change table width (if not fixed) 
								if(!o.fixWidth){
									wTable = (o.dragProxy) ? this.table_width - this.cell_width + parseInt(e.dragProxy.style.width) : this.table_width + delta; // oTable.clientWidth;
									oTable.style.width = wTable+"px";
									};
							}
						...
						.bind('minimized', function(e){
							$Cols.eq(this.td.cellIndex)[(parseInt(this.td.style.width) <= o.minWidth) ? "addClass":"removeClass"](o.classMinimized)
						});
					});
