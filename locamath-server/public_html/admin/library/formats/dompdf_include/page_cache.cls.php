...
class Page_Cache {
  ...
  static function store_page($id, $page_num, $data) {
    ...
    if ( $row ) 
      ...
      self::__query("INSERT INTO page_cache (id, page_num, data) VALUES ('" . pg_escape_st($id) . "' " . $where);
    else 
      self::__query("INSERT INTO page_cache (id, page_num, data) VALUES ('" . pg_escape_st($id($id) . "', ".
