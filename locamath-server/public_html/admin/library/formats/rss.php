  ...
  function parse ($url) {
    ...
    if ($content = download($url)) {
      ...
      foreach($rss_items as $rss_item) {
        ...
        if (safe($this->rss['items'][$i],'pubDate') && (($timestamp = strtotime($this->rss['items'][$i]['pubDate'])) !==-1)) {
