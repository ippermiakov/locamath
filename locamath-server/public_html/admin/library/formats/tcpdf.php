 ...
 */
require_once(dirname(__FILE__).'/tcpdf_config/tcpdf_config.php');
 ...
 * unicode data
 */
require_once(dirname(__FILE__).'/tcpdf_unicode_data.php');

/**
 * html colors table
 */
require_once(dirname(__FILE__).'/tcpdf_htmlcolors.php');
	...
	class TCPDF {
		...
		*/
		...
		public function write1DBarcode($code, $type, $x='', $y='', $w='', $h='', $xres=0.4, $style='', $align='') {
			...
			require_once(dirname(__FILE__).'/tcpdf_barcodes.php');
			// save current graphic settings
			$gvars = $this->getGraphicVars();
		...
		public function write2DBarcode($code, $type, $x='', $y='', $w='', $h='', $style='', $align='') {
			...
			require_once(dirname(__FILE__).'/tcpdf_2dbarcodes.php');
			// save current graphic settings
			$gvars = $this->getGraphicVars();
			// create new barcode object
