...
var $LayoutMode;         //layout display    //flag set when processing footer
var $ZoomMode;           //zoom display mode
...
{
        $default_dir = dirname(dirname(__FILE__)).'/_fonts/fpdf/';
	if(!defined('FPDF_FONTPATH') && is_dir($default_dir))
		define('FPDF_FONTPATH',$default_dir);
