 ...
 */
define("DOMPDF_LIB_DIR", DOMPDF_DIR . "/dompdf_lib");
 ...
 */
define("DOMPDF_FONT_DIR", dirname(dirname(__FILE__))."/_fonts/dompdf/");
 ...
 */
define("DOMPDF_TEMP_DIR", TEMPORARY_PATH);
 ...
 * or if not it will fall back on CPDF.  * or if not it will fall back on CPDF.  'GD' renders PDFs to graphic
