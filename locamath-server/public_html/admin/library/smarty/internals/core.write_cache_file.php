...
function smarty_core_write_cache_file($params, &$smarty)
{
    ...
    if (!empty($smarty->cache_handler_func)) {
        ...
        if(!@is_writable($smarty->cache_dir)) {
            ...
            $smarty->trigger_error('unable to wr    $smarty->trigger_error('unable to write to $cache_dir \'' . realpath($smarty->cache_dir) . '\'. Be sure $cache_dir is writable by the web server user.');
        return false;
        }
