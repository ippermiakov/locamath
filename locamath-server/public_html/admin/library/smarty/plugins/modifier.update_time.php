...
/**
 * Smarty update_time modifier plugin
 *
 * Type:     modifier<br>
 * Name:     update_time<br>
 * Purpose:  calculates update time based on $seconds parameter
 * $seconds_total  - seconds after last update
 ...
 * @return string
 */
function smarty_modifier_update_time($seconds_total, $allow_zero_value = false)
{
