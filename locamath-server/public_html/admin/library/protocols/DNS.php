...
/* Include information {{{ */
    ...
    require_once(dirname(__FILE__).'/DNS/Header.php');
    require_once(dirname(__FILE__).'/DNS/Question.php');
    require_once(dirname(__FILE__).'/DNS/Packet.php');
    require_once(dirname(__FILE__).'/DNS/Resolver.php');
    require_once(dirname(__FILE__).'/DNS/RR.php');
