...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if ([ChildManager sharedInstance].currentChild == nil) {
        ...
        //[self updateChildLocationIfNeeded];
    }
}
...
//- (void)updateChildLocationIfNeeded
//{
//    if ([[ChildManager sharedInstance].currentChild.city length] == 0 && [[MTHTTPClient sharedMTHTTPClient] isReachable] && ![[ChildManager sharedInstance].currentChild.isLocationPopupShown boolValue] && [ChildManager sharedInstance].currentChild.avatar != nil) {
//        
...
//        
//        PresentableViewController *nextVC = [seguesStructure nextViewController];
//        if (nextVC != nil) {
//            [nextVC presentOnViewController:self finish:nil];
//        }
//    }
//}
...
- (IBAction)onImage:(UIButton *)sender
{
    //NSLog(@"change images botton tap");
    PresentingSeguesStructure *seguesStructure = [PresentingSeguesStructure new];
