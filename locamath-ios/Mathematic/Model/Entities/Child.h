...
@class Game, Level, Task, AccountMail, AccountFB, HelpPage, Scheme, Parent, SpendTimeStatistic;
...
@property (retain, nonatomic) NSSet *spendTimes;
...
- (void)addSpendTimesObject:(SpendTimeStatistic *)value;
- (void)removeSpendTimesObject:(SpendTimeStatistic *)value;
- (void)addSpendTimes:(NSSet *)values;
- (void)removeSpendTimes:(NSSet *)values;
