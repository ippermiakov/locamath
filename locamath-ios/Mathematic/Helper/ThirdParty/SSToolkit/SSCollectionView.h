 ...
 */
@property (unsafe_unretained, nonatomic) id<SSCollectionViewDataSource> dataSource;

/**
 The object that acts as the delegate of the receiving collection view.
 */
@property (unsafe_unretained, nonatomic) id<SSCollectionViewDelegate> delegate;
