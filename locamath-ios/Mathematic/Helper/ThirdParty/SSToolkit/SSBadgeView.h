 ...
 */
@property (strong, nonatomic, readonly) SSLabel *textLabel;
 ...
 */
@property (strong, nonatomic) UIColor *highlightedBadgeColor;
...
/**
 ...
 Setting a strechable image for this property is recommended.
 */
@property (strong, nonatomic) UIImage *highlightedBadgeImage;
