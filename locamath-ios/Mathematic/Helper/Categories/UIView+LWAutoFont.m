...
//        NSLog(@"class: %@ text: %@", NSStringFromClass([self class]), [self performSelector:@selector(text)]);        
        ...
        selfLbl.textAlignment = [self currentTextAligmentForView:(UILabel*)selfLbl];
    }
    else if([self isKindOfClass:[UITextView class]])
    {
        ...
        selfTxVw.textAlignment = [self currentTextAligmentForView:(UILabel*)selfTxVw];
    }
...
- (NSTextAlignment)currentTextAligmentForView:(UILabel *)label
{
    if ([DataUtils isArabicLocale] && label.tag == kRightTextPositionsTag) {
