...
NSString * const kNotificationReloadComponents      = @"kNotificationReloadComponents";
...
//                NSLog(@"added %@ to parent", self);
                ...
                if (self.onMoveCompletionBlock) {
                    self.onMoveCompletionBlock(self);
                }
            }
        }();
    }
...
//    NSLog(@"contains %@ %i on hit %@ for frame %@", contains?@"!!! YES":@"NO", self.tag, NSStringFromCGPoint(point), NSStringFromCGRect(frame));
