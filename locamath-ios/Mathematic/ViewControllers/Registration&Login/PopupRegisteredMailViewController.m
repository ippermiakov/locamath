                                        ...
                                        shouldSaveAccessToken:YES
                                                      success:^(NSDictionary *successResponseData) {
                                                          ...
                                                          if (isAfterRegistration) {
                                                              [GameAlertViewController showGameAlertWithMessage:NSLocalizedString(@"You need to confirm your e-mail before continue", nil) withPresenter:self.basePresenterController.view];
