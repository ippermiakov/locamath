...
- (void)viewDidLoad
{
    ...
    if (self.isLast) {
        ...
        [self addComponents];
        self.totalLabel.tag = kRightTextPositionsTag;
...
- (void)addComponents
{
    ...
    //reduce width to align regardless of alignment (RTL/LTR)
    CGFloat labelWidth = self.scrollView.frame.size.width - 105;
    CGRect frameForLabel = CGRectMake(0, (viewHeight + 10) * [[DataUtils pathsFromCurrentChildForLevelNumber:@1] count], labelWidth, labelHeight);
