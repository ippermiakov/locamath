...
- (BaseViewController *)myPresentedViewController
{
   // NSLog(@"presentedViewController %@", [super presentedViewController] ?: self.presentedVC);
    return (BaseViewController *)([super presentedViewController] ?: self.presentedVC);
}

//first non presentable controller
- (BaseViewController *)basePresenterController
{
    PresentableViewController *presentableViewController = (PresentableViewController *)self;
    return ![self isKindOfClass:[PresentableViewController class]] ? self : [presentableViewController.myPresentingViewController basePresenterController];
}
